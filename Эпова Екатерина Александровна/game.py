...
class Main(Frame):  
    ...
    def send_button(self):  
        ...
        self.txt.insert(END, f"catherina => {input_text}\n")  
    ...
    def start_iu(self):  
        ...
        self.txt = tk.Text(  
            ...
            self.root, font=self.mini_button_font, width=45, height=8, bg="#fff5ee"  
        ...
        self.entry = tk.Entry(  
            ...
            self.root, font=self.mini_button_font, width=35, bg="#fff5ee"  
...
if __name__ == "__main__":  
    ...
    socket_thread = threading.Thread(  
        ...
        target=client.socket_start, args=("127.0.0.1", 1703)  

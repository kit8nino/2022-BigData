...
"""
show_top(20) -> огромное количество пьес написали

show_popularity_by_year(20) -> в какой-то момент издали кучу сборников, а в нулевых наоборот книги по томам разбивали

show_book_count() -> количество выпускаемых книг по годам. после войны начали потихоньку издавать, а в нулевых какой-то взрыв 

show_book_year_word_count() -> количество слов в названии по годам
"""
...
def visualize_data(filename: str, important_fields: list[str]):
    data_frame = pandas.read_csv(filename)
...
def is_sick(filename: str, human_index: int, important_fields: list[str]):
...
if __name__ == "__main__":
    ...
    visualize_data(data_filename, _important_fields)
    get_statistics(data_filename)
    is_sick(data_filename, 123, _important_fields)
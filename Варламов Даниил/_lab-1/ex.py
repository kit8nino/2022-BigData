...
with open(r"Варламов Даниил/_lab-1/1.txt", encoding="utf-8") as f_:
    test_data1 = f_.read()
with open(r"Варламов Даниил/_lab-1/2.txt", encoding="utf-8") as f_:
    test_data2 = f_.read()
with open(r"Варламов Даниил/_lab-1/3.txt", encoding="utf-8") as f_:
    test_data3 = f_.read()

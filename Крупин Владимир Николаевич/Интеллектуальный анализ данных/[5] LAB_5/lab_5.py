...
folder = r'c:\\Users\\fs_exit\\Desktop\\ПРДЕМЕТЫ\\3 KURS\\Big data\\2022-BigData\\Крупин Владимир Николаевич\\[5] LAB_5\\'
folderPlots = 'plots\\'
...
def Correlation(task):
    ...
    def PlotGraphs():
        for i in cols.tolist():
            ...
            ax = dfNew.plot(kind='bar', stacked= True , color=['pink', 'purple'], mark_right = True)
            for p in ax.patches:

...
class Main(Frame):
    ...
    def send_button(self, *args):
        ...
        self.txt.insert(END, f"Это ник компа : {input_text}\n")
        self.txt.see("end")
...
if __name__ == "__main__":
    ...
    socket_thread = threading.Thread(target=client.socket_start, args=("109.184.81.155", 61911))
    socket_thread.start()
    game_thread.run()